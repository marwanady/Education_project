...
$sql = "SELECT meeting_title, meeting_price, meeting_image, meeting_content, meeting_location ,meeting_id, category_id ,
 DATE_FORMAT(meeting_date, '%e %b') AS meeting_date FROM meetings WHERE meeting_id=$id";
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                ...
                <div class="down-content">
                  <a href="meeting-details.php"><h4><?php echo $row["meeting_title"]; ?></h4></a>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="location">
                        <h5>Location</h5>
                        <p><?php echo $row["meeting_location"]; ?></p>
                      </div>
                    </div>
                    <?php } ?>
                    <div class="col-lg-4">
