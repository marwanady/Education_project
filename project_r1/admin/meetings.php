                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
                        foreach ($data as $row) {
                          ...
                          <td>{$active}</td>";?>
                          <td><a href='./editMeeting.php?id=<?php echo $row['meeting_id'];?>'><img src="./images/edit.png" alt="Edit"></a></td>
                          <td><a href='./delete_meeting.php?id=<?php echo $row['meeting_id'];?>'><img src="./images/delete.png" alt="Delete"></a></td>
