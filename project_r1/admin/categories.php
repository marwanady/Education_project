                      ...
                      <?php
                        foreach ($data as $row) {
                          ...
                          <td>{$row['category_name']}</td>";?>
                           <td><a href='./editCategory.php?id=<?php echo $row['category_id'];?>'><img src="./images/edit.png" alt="Edit"></a></td>
                          <td><a href='./delete_category.php?id=<?php echo $row['category_id'];?>'><img src="./images/delete.png" alt="Delete"></a></td>
